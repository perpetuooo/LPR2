...
public class FormPessoa extends JFrame implements ActionListener {
    ...
    public FormPessoa() {
        ...
        c.gridx = 1; c.gridy = 2; form.add(fSexo, c);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bOk) {
            try {
                ...
                String sx = fSexo.getText().trim().toUpperCase();
                String idt = fIdade.getText().trim();

                if (nome.isEmpty() || sx.isEmpty() || idt.isEmpty()) throw new Exception();
